...
namespace AppForSEII2526.UT.RentalsController_test
{
    public class Get_Details_Rental_test : AppForSEII25264SqliteUT
    {
        ...
        public async Task GetDetailsRental_Found_test()
        {
            ...
            var expectedRental = new RentalDetailDTO(1, "Elena", "Navarro Martinez", "elena@navarro", "Madrid Center", Rental.RentalPaymentMethodEnum.Visa, DateTime.Today, DateTime.Today.AddDays(7), DateTime.Today.AddDays(1), 0,new List<RentalItemDTO>());
