...
namespace AppForSEII2526.UT.RentalsController_test
{
    public class Get_Details_Rental_test : AppForSEII25264SqliteUT
    {
        public Get_Details_Rental_test()
        {
            ...
            var rental = new Rental("Madrid Center", DateTime.Today.AddDays(7), Rental.RentalPaymentMethodEnum.Visa, DateTime.Today.AddDays(1), DateTime.Today, new List<RentalItem>(), user);
        ...
        public async Task GetDetailsRental_NotFound_test()
        {
            ...
            // Act
            var result = await controller.Get_Details_Rental(0);
