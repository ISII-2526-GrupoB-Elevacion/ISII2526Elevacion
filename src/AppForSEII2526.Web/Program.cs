...
builder.Services.AddScoped<AppForSEII2526APIClient>(sp =>(AppForSEII2526APIClient)Activator.CreateInstance(typeof(AppForSEII2526APIClient), URI2API!, new HttpClient())!);
