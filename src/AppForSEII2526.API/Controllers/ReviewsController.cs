    ...
    public class ReviewsController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetDetailsReview(int id)
        {
            ...
            var review = await _context.Review //voy haciendo joins hasta tener todos los datos que se me piden
             ...
             .Select(p => new ReviewDetailDTO(p.Id, p.ApplicationUser.Name, p.ApplicationUser.Surname, p.ApplicationUser.UserName, p.Country, p.DriverType, p.Created, p.ReviewItems
