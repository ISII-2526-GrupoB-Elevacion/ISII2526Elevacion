        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentingPrice = table.Column<float>(type: "real", nullable: false),
                    EngDisplacement = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    FuelType = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    MaintenanceTypes = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    RimSize = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseItem", x => new { x.CarId, x.PurchaseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalItem", x => new { x.CarId, x.RentalId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewItem", x => new { x.CarId, x.ReviewId });
                    table.ForeignKey(
